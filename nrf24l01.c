...
//引脚接口：1号：GND         2号：VCC
//          3号：CE-----PD8  4号：CSN-----PD9
//          5号：SCK----PB13 6号：MOSI----PB15
//          7号：MISO---PB14 8号：IRQ-----PD10   功放 PD11
...
void NRF24L01_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOB, ENABLE);	 //使能PB,D,G端口时钟
						
	

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_11;    //PD8 9 推挽 
    ...
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD;           //PD10 IRQ 输入  
...
void NRF24L01_RX_Mode(void)
{
    ...
    NRF24L01_CE=0;	  
  	...
  	NRF24L01_Write_Reg(WRITE_REG_NRF+RF_CH,0);	     //设置RF通信频率为2.4G		  
...
//			  break;
//			
//	    while((NRF24L01_RxPacket(rev_buf))==0)
//			{

//					NRF24L01_TX_Mode();         //24L01切换进入发送模式
//					NRF24L01_TxPacket(rev_buf);    //启动NRF24L01发送一次数据
//					
//					NRF24L01_RX_Mode();
//				
//		    if(rev_buf[1] == 0xA5 && rev_buf[2] == 0xA5)
//	      {
//						switch(rev_buf[3])
//						{
//							case 0x2a:     //IMU需要校准
